...
pg_restore: error: could not execute query: ERROR:  permission denied for table job
...
pg_restore: error: could not execute query: ERROR:  must be owner of index identities_email_idx
...
pg_restore: error: could not execute query: ERROR:  permission denied to change
Command was: ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public G
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON S
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON S
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON S
...
pg_restore: error: could not execute query: ERROR:  permission denied to change
Command was: ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public G
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON F
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON F
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON F
...
pg_restore: error: could not execute query: ERROR:  permission denied to change
Command was: ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public G
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON T
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON T
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA public GRANT ALL ON T


pg_restore: error: could not execute query: ERROR:  permission denied to change
Command was: ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA realtime
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA realtime GRANT ALL ON
...
pg_restore: error: could not execute query: ERROR:  Non-superuser owned event tr
DETAIL:  The current user "postgres" is not a superuser and the function "extens
...
pg_restore: warning: errors ignored on restore: 405
